...
if(CPACK_GENERATOR MATCHES "NSIS")
  ...
  set(CPACK_NSIS_MUI_ICON "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/Utilities/Release\\CMakeLogo.ico")
  set(CPACK_NSIS_MUI_UNIICON "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/Utilities/Release\\CMakeLogo.ico")
  # set the package header icon for MUI
  set(CPACK_PACKAGE_ICON "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/Utilities/Release\\CMakeInstall.bmp")
  ...
  set(CPACK_NSIS_PACKAGE_NAME "CMake 3.26.4")
  set(CPACK_NSIS_DISPLAY_NAME "CMake 3.26.4, a cross-platform, open-source build system")
...
include("/workspace/clang-quickstart/code/cmake/cmake-3.26.4/Source/QtDialog/QtDialogCPack.cmake" OPTIONAL)
...
if(CPACK_GENERATOR MATCHES "IFW")
  ...
  set(CPACK_IFW_PACKAGE_WINDOW_ICON
    "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/Source/QtDialog/CMakeSetup128.png")
  set(CPACK_IFW_PACKAGE_CONTROL_SCRIPT
    "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/Source/QtIFW/controlscript.qs")
  ...
  set(CPACK_IFW_COMPONENT_GROUP_CMAKE_SCRIPT_TEMPLATE
    "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/Source/QtIFW/installscript.qs.in")
  set(CPACK_IFW_COMPONENT_GROUP_CMAKE_SCRIPT_GENERATED
    "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/CMake.qs")
  set(CPACK_IFW_COMPONENT_GROUP_CMAKE_LICENSES
    "CMake Copyright;/workspace/clang-quickstart/code/cmake/cmake-3.26.4/Copyright.txt")
  ...
  set(CPACK_IFW_COMPONENT_CMAKE-GUI_SCRIPT
    "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/CMake.Dialogs.QtGUI.qs")
  ...
  set(CPACK_IFW_COMPONENT_SPHINX-HTML_SCRIPT
    "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/CMake.Documentation.SphinxHTML.qs")
  ...
  set(CPACK_IFW_COMPONENT_CMAKE-DEVELOPER-REFERENCE-HTML_SCRIPT
    "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/CMake.DeveloperReference.HTML.qs")
...
if("${CPACK_GENERATOR}" STREQUAL "DragNDrop")
  set(CPACK_DMG_BACKGROUND_IMAGE
      "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/Packaging/CMakeDMGBackground.tif")
  set(CPACK_DMG_DS_STORE_SETUP_SCRIPT
      "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/Packaging/CMakeDMGSetup.scpt")
endif()
...
if("${CPACK_GENERATOR}" STREQUAL "WIX")
  ...
  set(CPACK_PACKAGE_FILE_NAME
    "cmake-3.26.4-${CPACK_SYSTEM_NAME}")
  ...
  set(CPACK_WIX_PRODUCT_ICON
    "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/Utilities/Release/CMakeLogo.ico"
  )
  ...
  set(CPACK_WIX_UI_BANNER
    "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/Utilities/Release/WiX/ui_banner.jpg"
  )

  set(CPACK_WIX_UI_DIALOG
    "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/Utilities/Release/WiX/ui_dialog.jpg"
  )

  set(CPACK_WIX_EXTRA_SOURCES
    "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/Utilities/Release/WiX/install_dir.wxs"
    "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/Utilities/Release/WiX/cmake_extra_dialog.wxs"
  )

  set(_WIX_CUSTOM_ACTION_ENABLED "FALSE")
  if(_WIX_CUSTOM_ACTION_ENABLED)
    list(APPEND CPACK_WIX_EXTRA_SOURCES
      "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/Utilities/Release/WiX/cmake_nsis_overwrite_dialog.wxs"
      )
    ...
    if(_WIX_CUSTOM_ACTION_MULTI_CONFIG)
      ...
      list(APPEND CPACK_WIX_EXTRA_SOURCES
        "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/Utilities/Release/WiX/custom_action_dll-${_WIX_CUSTOM_ACTION_CONFIG}.wxs")
    else()
      list(APPEND CPACK_WIX_EXTRA_SOURCES
        "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/Utilities/Release/WiX/custom_action_dll.wxs")
    endif()
  endif()
  ...
  set(CPACK_WIX_PATCH_FILE
    "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/Utilities/Release/WiX/patch_path_env.xml"
  )

  set(CPACK_WIX_TEMPLATE
    "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/Utilities/Release/WiX/WIX.template.in"
  )
  ...
  if(BUILD_QtDialog)
    list(APPEND CPACK_WIX_PATCH_FILE
      "/workspace/clang-quickstart/code/cmake/cmake-3.26.4/Utilities/Release/WiX/patch_desktop_shortcut.xml"
      )
